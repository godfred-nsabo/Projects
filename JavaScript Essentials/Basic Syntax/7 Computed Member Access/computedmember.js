...
console.log ( car.performance.engine_power[0] );
...
console.log ( array[num - 5 - 3] );

console.log( car["make"] );

console.log( car["release_date"]);

console.log( car["performance"]["engine_power"][2] );

console.log( car["vehicle_dimension"]["dimension"] );

console.log( car["performance"]["engine_power"][2]["RPM"] );


var pointer = " fuel_consumption";

console.log( pointer );

console.log( car["emi" + "ssion"] );
