...
console.log( car.make = "Chevi" );

console.log( car.make += 2021 );

console.log( car.engine.valves *=2 );
// creating new member 
console.log( car.color = "wine");
//creating a new method
console.log( car.stop = function(){ return "stop";})

console.log( car.engine.stop = function(){ return "stop the egine";})
